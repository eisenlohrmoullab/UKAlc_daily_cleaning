...
#am_data_cycleday %>% group_by(ID) %>% slice(1) %>% select(ID, drinkingprob.m) ###Anna: I commented this out here bc it doesn't appear to be relevant to my dataset right now 11/29/23

#person-mean-center
# data_cycleday_plot <- am_data_cycleday %>% 
