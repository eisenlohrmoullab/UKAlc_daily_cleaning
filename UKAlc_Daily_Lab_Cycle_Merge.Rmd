...
#Add new column for second menses start date 
Second.Menses.Date$secondmenses <- 1 
...
#Remove NAs (participants with only one menses start date)
Second.Menses.Date <- Second.Menses.Date[complete.cases(Second.Menses.Date), ]  # maybe add if you can still merge by ID  
```
