...
##Alc Urge
ggplot(am_data, aes(x = factor(DayOfWeek), y = Urg_Alc_am)) +
  geom_boxplot() +
  labs(x = "Day of the Week", y = "Alcohol Urge") +
  scale_x_discrete(labels = c("Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"))
ggplot(am_data, aes(x = factor(DayOfWeek), y = Crav_Alc_am)) +
  geom_boxplot() +
  labs(x = "Day of the Week", y = "Alcohol Craving") +
  scale_x_discrete(labels = c("Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"))
```
