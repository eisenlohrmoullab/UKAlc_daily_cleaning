...
#Calculate luteal phase by subtracting the period start date column by posov_pred column 



#Code below is potentially all going to be deleted. These were things I was trying out while cleaning the data. 
