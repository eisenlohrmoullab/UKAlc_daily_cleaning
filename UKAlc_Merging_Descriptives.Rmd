...
#step 1: make variables numeric that aren't already 
pm_data$Diff_Inhib_pm <- as.numeric(pm_data$Diff_Inhib_pm)
##the above code seemed to make them all NA - figure out how to remove statement portion of column so that you can code the responses as numerics 
