...
```{r}
hormones <- separate(hormones.lab, col = Sample, into = c("ID", "day_in_study"), sep = "-")
...
# merge hormone data w am_data_cleaned and pm_data_cleaned 
```{r}
am_data_clean_horm <- merge(am_data_clean, hormones, by = c("ID", "dayinstudy"), all = T)
```
