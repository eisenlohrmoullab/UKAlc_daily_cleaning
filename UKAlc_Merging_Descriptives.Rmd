...
pm_data <- pm_data %>% drop_na(DateTime)
...
#it seems to make more sense to assign them to the date prior automatically and then examine duplicates 
...
pm_data <- changedatepm(103, "0:08", "5/01/21","4/31/21")
```
